...
interface OnSaveClicked {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            ...
            if (task != null) {
                ...
                // No task, so we must add a new task, and not editing an existing one
    ...
    private fun saveTask() {
        // Create a newTask object with the details to be saved,
    ...
    companion object {
         ...
         *
         * @param task The task to be edited, or nbull to add a new task.
