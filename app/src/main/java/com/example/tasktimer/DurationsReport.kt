...
class DurationsReport : AppCompatActivity(), DatePickerDialog.OnDateSetListener,View.OnClickListener, AppDialog.DialogEvents {
    ...
    private val viewModel by lazy {
        ViewModelProviders.of(this).get(DurationsViewModel::class.java)
    }
    ...
    override fun onPrepareOptionsMenu(menu: Menu): Boolean {
        ...
        if (item != null) {
            if (viewModel.displayWeek) {    // switch icon and title to represent 7 days or 1 day, as appropriate to the future function of the menu item
